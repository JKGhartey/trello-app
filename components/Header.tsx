...
<div className='absolute top-0 left-0 w-full h-96 bg-gradient-to-br from-pink-400 to-[#0055D1] rounded-md filter blur-3xl opacity-50 -z-50 ' />
                ...
                <div className="flex items-center space-x-5 flex-1 justify-end ">
                    <form action="" className='flex items-center space-x-5 bg-white rounded-full p-2 px-4 shadow-md flex-1 md:flex-initial'>
                    ...
                    {/* Avatar */}
                    <Avatar name='Jerome Ghartey' round color='#0055D1' size='50' />
                </div>
            </div>
